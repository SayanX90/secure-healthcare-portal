...
import AdminStats from "@/frontend/components/adminDashboard/AdminStats";
import InfoCard from "@/frontend/components/adminDashboard/InfoCard";
...
const UsersTable = dynamic(
  () => import("@/frontend/components/tables/adminTables/UsersTable"),
  {
    loading: () => (
